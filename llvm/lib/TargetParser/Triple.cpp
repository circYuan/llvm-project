...
StringRef Triple::getArchTypeName(ArchType Kind) {
  ...
  case riscx32:        return "riscx32";
  case riscx64:        return "riscx64";
...
Triple::ArchType Triple::getArchTypeForLLVMName(StringRef Name) {
  ...
  return StringSwitch<Triple::ArchType>(Name)
    ...
    .Case("riscx32", riscx32)
    .Case("riscx64", riscx64)
...
static Triple::ArchType parseArch(StringRef ArchName) {
  auto AT =
      StringSwitch<Triple::ArchType>(ArchName)
          ...
          .Case("riscx32", Triple::riscx32)
          .Case("riscx64", Triple::riscx64)
...
Triple Triple::get32BitArchVariant() const {
  ...
  case Triple::riscx64:        T.setArch(Triple::riscx32); break;
...
Triple Triple::get64BitArchVariant() const {
  ...
  case Triple::riscx32:         T.setArch(Triple::riscx64);    break;
